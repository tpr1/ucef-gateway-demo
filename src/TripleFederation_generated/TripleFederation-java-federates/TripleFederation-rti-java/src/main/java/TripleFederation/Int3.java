...
/**
* The Int3 class implements the Int3 interaction in the
* TripleFederation simulation.
*/
public class Int3 extends C2WInteractionRoot {

	private static final Logger logger = LogManager.getLogger(Int3.class);

	/**
	* Default constructor -- creates an instance of the Int3 interaction
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the Int3 interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the Int3
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	*/
	public static String get_class_name() { return "InteractionRoot.C2WInteractionRoot.Int3"; }

	/**
	* Returns the simple name (the last name in the dot-delimited fully-qualified
	* class name) of the Int3 interaction class.
	*/
	public static String get_simple_class_name() { return "Int3"; }
	...
	*/
	...
	static {
		_classNameSet.add("InteractionRoot.C2WInteractionRoot.Int3");
		_classNameClassMap.put("InteractionRoot.C2WInteractionRoot.Int3", Int3.class);
		
		_datamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.Int3", _datamemberNames);
		_allDatamemberClassNameSetMap.put("InteractionRoot.C2WInteractionRoot.Int3", _allDatamemberNames);
	...
	private static String initErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.Int3:  could not initialize:  ";
	protected static void init(RTIambassador rti) {
		...
		while(isNotInitialized) {
			try {
				_handle = rti.getInteractionClassHandle("InteractionRoot.C2WInteractionRoot.Int3");
		...
		_classNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Int3", get_handle());
		_classHandleNameMap.put(get_handle(), "InteractionRoot.C2WInteractionRoot.Int3");
		_classHandleSimpleNameMap.put(get_handle(), "Int3");
		...
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Int3,boolVal", get_boolVal_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Int3,intVal", get_intVal_handle());
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.Int3,strVal", get_strVal_handle());
	...
	private static String publishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.Int3:  could not publish:  ";

	/**
	* Publishes the Int3 interaction class for a federate.
	*
	...
	*/
	...
	private static String unpublishErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.Int3:  could not unpublish:  ";
	/**
	* Unpublishes the Int3 interaction class for a federate.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	private static String subscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.Int3:  could not subscribe:  ";
	/**
	* Subscribes a federate to the Int3 interaction class.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	private static String unsubscribeErrorMessage = "Error:  InteractionRoot.C2WInteractionRoot.Int3:  could not unsubscribe:  ";
	/**
	* Unsubscribes a federate from the Int3 interaction class.
	*
	* @param rti handle to the Local RTI Component
	*/
	...
	* (that is, the Int3 interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the Int3 interaction class).
	...
	*/
	...
	protected Int3( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected Int3( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the Int3 interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new Int3 interaction class instance
	*/
	public Int3( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #Int3( ReceivedInteraction datamemberMap )}, except this
	* new Int3 interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new Int3 interaction class instance
	* @param logicalTime timestamp for this new Int3 interaction class
	* instance
	*/
	public Int3( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new Int3 interaction class instance that is a duplicate
	* of the instance referred to by Int3_var.
	*
	* @param Int3_var Int3 interaction class instance of which
	* this newly created Int3 interaction class instance will be a
	* duplicate
	*/
	public Int3( Int3 Int3_var ) {
		super( Int3_var );
		
		
		set_boolVal( Int3_var.get_boolVal() );
		set_intVal( Int3_var.get_intVal() );
		set_strVal( Int3_var.get_strVal() );
	}
